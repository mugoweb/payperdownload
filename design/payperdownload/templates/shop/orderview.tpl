{* Override for shop/orderview.tpl *}
...
<tr class="{$style}">
    ...
    {if $download_classes|contains($product_item.item_object.contentobject.class_identifier)}
        ...
        <br />
        - Download: <a href={concat('content/download/',$product_item.item_object.contentobject.data_map.$download_attribute.content.id,'/',$product_item.item_object.contentobject.data_map.$download_attribute.content.data_map.file.id)|ezurl()}>{$product_item.item_object.contentobject.data_map.$download_attribute.content.name}</a>
